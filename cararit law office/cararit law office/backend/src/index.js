...
// ============================
// SECURITY & MIDDLEWARES (ULTIMATE CORS FIX)
// ============================
...
const corsOptions = {
  origin: function (origin, callback) {
    ...
    // Payagan kung nasa allowed list, o kung walang origin (tulad ng Postman)
  ...
  credentials: true,
  optionsSuccessStatus: 200 // Para sa mga browsers na nag-e-error sa 204 status
};

// I-apply ang CORS sa lahat ng requests
app.use(cors(corsOptions));

// Sagutin ang lahat ng OPTIONS (Preflight) requests
